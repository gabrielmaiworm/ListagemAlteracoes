...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APARTAMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APARTAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APARTAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APARTAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APARTAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APARTAMENTO actions', async () => {
      const expectedActions = [
        {
